...
public class GlobeTMProcessActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_globe_tm_activity);
        ...
        dbHandlerMustPromo = new DBHandlerMustPromo(GlobeTMProcessActivity.this);
    ...
    private void FilterPromo(View view){
        ...
        bottomSheetDialog = new BottomSheetDialog(GlobeTMProcessActivity.this);
